...
Main_Data;
% Batasan Pembangkit Pmin dan Pmax 
PVB=[mwlimits(1,1) mwlimits(1,2);
     mwlimits(2,1) mwlimits(2,2)
     mwlimits(3,1) mwlimits(3,2)
     mwlimits(4,1) mwlimits(4,2)
     mwlimits(5,1) mwlimits(5,2)
     mwlimits(6,1) mwlimits(6,2)];
% /**** Initiate Matrix ****/
HM=zeros(HMS,NVAR);
NCHV=zeros(1,NVAR);
